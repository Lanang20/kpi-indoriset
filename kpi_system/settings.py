...
ALLOWED_HOSTS = []  # sesuaikan username kamu

AUTH_USER_MODEL = 'kpi.Pegawai'
...
MIDDLEWARE = [
    ...
    "kpi.middleware.Custom404Middleware",
]
...
# ── SHAREPOINT CREDENTIALS (dari .env) ─────────
